...
class ServiceResponse
{
    ...
    public static function internalServerError($message = '', $data = null): self
    {
        $msg = $message ? 'internal server error (' . $message . ')' : 'internal server error';
        return new self(false, 500, $msg, $data, null);
    }

    public static function forbidden($message = '', $data = null): self
    {
        $msg = $message ? $message : 'forbidden';
        return new self(false, 403, $msg, $data, null);
    }

    public static function notFound($message = '', $data = null): self
    {
        $msg = $message ? $message : 'not found';
        return new self(false, 404, $msg, $data, null);
    }

    public static function unauthorized($message = '', $data = null): self
    {
