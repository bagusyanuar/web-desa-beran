...
namespace App\Schemas\Landing\OnlineLetter\MaritalStatus;

use App\Commons\Libs\Http\BaseSchema;

class MaritalStatusSchema extends BaseSchema
{
    private $name;
    private $nik;
    private $birthPlace;
    ...
    protected function rules()
    {
        return [
            ...
            'marriage' => 'required|in:divorced,widowed',
            'job' => 'string',
            'address' => 'required|string',
            'spouseName' => 'required|string',
            'type' => 'required|in:widow,widower',
    ...
    protected function messages()
    {
        return [
            ...
            'spouseName.required' => 'kolom pasangan wajib diisi',
    ...
    public function hydrateBody()
    {
        ...
        $spouseName = $this->body['spouseName'];
        $type = $this->body['type'];
