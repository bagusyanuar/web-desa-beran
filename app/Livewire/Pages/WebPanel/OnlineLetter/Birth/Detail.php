...
class Detail extends Component
{
    ...
    {
        $schema = (new BirthConfirmationSchema())->hydrateSchemaBody($body);
    ...
    private function generateChatTextLink()
    {
        ...
        $name = $this->data->infant->name;

        $header = "Pemberitahuan Pengajuan Surat Keterangan Kelahiran Desa Beran\n\n";
    ...
    {
        return view('livewire.pages.web-panel.online-letter.birth.detail');
    }
}
