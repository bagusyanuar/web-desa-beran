...
class Detail extends Component
{
    ...
    {
        $schema = (new DeathConfirmationSchema())->hydrateSchemaBody($body);
    ...
    private function generateChatTextLink()
    {
        ...
        $header = "Pemberitahuan Pengajuan Surat Keterangan Kematian Desa Beran\n\n";
    ...
    {
        return view('livewire.pages.web-panel.online-letter.death.detail');
    }
}
