...
class Detail extends Component
{
    ...
    {
        $schema = (new IncomeConfirmationSchema())->hydrateSchemaBody($body);
    ...
    private function generateChatTextLink()
    {
        ...
        $header = "Pemberitahuan Pengajuan Surat Keterangan Penghasilan Desa Beran\n\n";
    ...
    {
        return view('livewire.pages.web-panel.online-letter.income.detail');
    }
}
