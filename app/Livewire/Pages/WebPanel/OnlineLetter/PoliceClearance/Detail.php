...
class Detail extends Component
{
    ...
    {
        $schema = (new PoliceClearanceConfirmationSchema())->hydrateSchemaBody($body);
    ...
    private function generateChatTextLink()
    {
        ...
        $header = "Pemberitahuan Pengajuan Surat Pengantar Keterangan Catatan Kepolisian Desa Beran\n\n";
    ...
    {
        return view('livewire.pages.web-panel.online-letter.police-clearance.detail');
    }
}
