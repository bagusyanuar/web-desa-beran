...
namespace App\Livewire\Pages\WebPanel\OnlineLetter\Widow;
...
class Detail extends Component
{
    ...
    private function generateChatTextLink()
    {
        ...
        $header = "Pemberitahuan Pengajuan Surat Keterangan Janda Desa Beran\n\n";
    ...
    {
        return view('livewire.pages.web-panel.online-letter.widow.detail');
    }
}
