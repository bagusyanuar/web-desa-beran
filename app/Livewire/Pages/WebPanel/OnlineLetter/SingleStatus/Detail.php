...
class Detail extends Component
{
    ...
    {
        $schema = (new SingleStatusConfirmationSchema())->hydrateSchemaBody($body);
    ...
    private function generateChatTextLink()
    {
        ...
        $header = "Pemberitahuan Pengajuan Surat Keterangan Belum Menikah Desa Beran\n\n";
    ...
    {
        return view('livewire.pages.web-panel.online-letter.single-status.detail');
    }
}
