...
class Detail extends Component
{
    ...
    {
        $schema = (new ParentIncomeConfirmationSchema())->hydrateSchemaBody($body);
    ...
    private function generateChatTextLink()
    {
        ...
        $header = "Pemberitahuan Pengajuan Surat Keterangan Penghasilan Orang Tua Desa Beran\n\n";
    ...
    {
        return view('livewire.pages.web-panel.online-letter.parent-income.detail');
    }
}
