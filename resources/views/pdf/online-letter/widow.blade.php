        ...
        <tr>
            ...
            <td>
                ...
                <div class="w-full">
                    ...
                    <p class="text-md" style="text-indent: 50px; line-height: 2; text-align: justify; margin-bottom: 15px;">
                        Nama tersebut di atas, benar- benar Penduduk Desa Beran Kec./Kab. Ngawi, janda dari
                       {{ $certificate->person->marriage === 'widowed' ? 'almarhum' : '' }} saudara / bapak {{ $certificate->person->spouse_name }}.
                    </p>
                    <p class="text-md" style="text-indent: 50px; line-height: 2; text-align: justify; margin-bottom: 15px;">
