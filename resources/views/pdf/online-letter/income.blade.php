        ...
        <tr>
            ...
            <td>
                ...
                <div class="w-full">
                    ...
                    <p class="text-md" style="text-indent: 50px; line-height: 2; text-align: justify; margin-bottom: 15px;">
                        Nama tersebut di atas benar- benar Penduduk Desa Beran Kec./Kab. Ngawi yang mempunyai penghasilan
                        tiap bulan <span style="font-weight: bold;">Rp. {{ number_format($certificate->income_per_month, 0, ',', '.') }}</span> surat keterangan ini
                        diberikan ini diberikan guna {{ $certificate->purpose}}.
                    </p>
                    <p class="text-md" style="text-indent: 50px; line-height: 2; text-align: justify; margin-bottom: 15px;">
