...
@section('content')
    ...
    <p class="text-md font-bold line-press" style="margin-top: 3px; margin-bottom: 15px; text-align: center;">Nomor : 400.12.3.2
        ...
        <tr>
            ...
            <td>
                ...
                <div class="w-full">
                    ...
                    <p class="text-md" style="text-indent: 50px; line-height: 2; text-align: justify; margin-bottom: 15px;">
                        Nama tersebut di atas benar – benar penduduk Desa Beran Kec / Kab Ngawi, sampai saat surat
                        keterangan ini diberikan benar belum pernah melaksanakan pernikahan dan belum tercatat dalam
                        regester buku pernikahan.
                    </p>
                    <p class="text-md" style="text-indent: 50px; line-height: 2; text-align: justify; margin-bottom: 15px;">
