...
@section('content')
                    ...
                    <div style="border: 1px solid black; border-radius: 3px; margin-bottom: 10px;">
                        <table class="w-full" style="border-collapse: collapse;">
                            ...
                            <tr style="border-bottom: 1px solid black;">
                                <td
                                    style="width: 30%; vertical-align: top; padding-left: 5px; padding-top: 3px; padding-bottom: 3px;">
                                    <span class="text-sm" style="line-height: 1.2; margin-bottom: 0;">Nama Anak</span>
                                </td>
                                <td style="width: 5px; vertical-align: top; padding-top: 3px; padding-bottom: 3px;">
                                    <span class="text-sm" style="line-height: 1.2; margin-bottom: 0;">:</span>
                                </td>
                                <td style="vertical-align: top; padding-right: 5px; padding-top: 3px; padding-bottom: 3px;">
                                    <span class="text-sm"
                                        style="line-height: 1.2; margin-bottom: 0;">{{ $certificate->infant->name }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td
                                    style="width: 30%; vertical-align: top;  padding-left: 5px; padding-top: 3px; padding-bottom: 3px;">
                                    <span class="text-sm" style="line-height: 1.2; margin-bottom: 0;">Tempat, Tanggal
                                        Lahir</span>
                                </td>
                                <td style="width: 5px; vertical-align: top; padding-top: 3px; padding-bottom: 3px;">
                                    <span class="text-sm" style="line-height: 1.2; margin-bottom: 0;">:</span>
                                ...
                                <td style="vertical-align: top; padding-right: 5px; padding-top: 3px; padding-bottom: 3px;">
                                    ...
                                    @endphp
                                    <span class="text-sm"
                                        style="line-height: 1.2; margin-bottom: 0;">{{ $certificate->infant->birth_place . ', ' . \Carbon\Carbon::parse($certificate->infant->date_of_birth)->translatedFormat('d F Y') }}</span>
                                </td>
                            </tr>
                        </table>
                    </div>
    ...
    <p class="text-xs" style="line-height: 1; color: black; font-style: italic">atau Kunjungi
        {{ route('online-letter.birth.code', [
