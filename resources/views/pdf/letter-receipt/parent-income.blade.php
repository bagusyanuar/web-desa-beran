                    ...
                    <div style="border: 1px solid black; border-radius: 3px; margin-bottom: 10px;">
                        <table class="w-full" style="border-collapse: collapse;">
                            ...
                            <tr style="border-bottom: 1px solid black;">
                                ...
                                <td style="vertical-align: top; padding-right: 5px; padding-top: 3px; padding-bottom: 3px;">
                                    <span class="text-sm"
                                        style="line-height: 1.2; margin-bottom: 0;">Rp.{{ number_format($certificate->father_income_per_month, 0, ',', '.') }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td
                                ...
                                <td style="vertical-align: top; padding-right: 5px; padding-top: 3px; padding-bottom: 3px;">
                                    <span class="text-sm"
                                        style="line-height: 1.2; margin-bottom: 0;">Rp.{{ number_format($certificate->mother_income_per_month, 0, ',', '.') }}</span>
                                </td>
                            </tr>
                        </table>
                    </div>
