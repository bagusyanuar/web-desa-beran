<section id="online-letter-widow" data-component-id="online-letter-widow" class="w-full">
    ...
    <div class="w-full py-10">
        <x-container.landing-container class="">
            <p class="text-center text-accent-500 text-lg font-bold mb-10">
                FORMULIR SURAT KETERANGAN JANDA PENDUDUK DESA BERAN
            </p>
            <div class="w-5/6 justify-self-center bg-white rounded-xl shadow-xl p-6 border border-neutral-300">
                <div class="w-full">
                    <div
                        ...
                        <div class="flex-1">
                            <p class="text-sm mb-3">Sehubungan dengan pengajuan Surat Keterangan Janda, bersama ini
                                kami
                    ...
                    <div class="w-full grid grid-cols-2 gap-x-7 gap-y-7">
                        <div class="w-full">
                            ...
                            <x-input.text.text id="name" x-model="$store.SERVICE_WIDOW_STORE.form.name" />
                            <template x-if="'name' in $store.SERVICE_WIDOW_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_WIDOW_STORE.formValidator.name[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full">
                            ...
                            <x-input.text.text id="nik" x-model="$store.SERVICE_WIDOW_STORE.form.nik" />
                            <template x-if="'nik' in $store.SERVICE_WIDOW_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_WIDOW_STORE.formValidator.nik[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full">
                        ...
                        <div class="w-full">
                            ...
                            <x-input.date.datepicker id="date-of-birth" store="SERVICE_WIDOW_STORE"
                                stateDate="form.dateOfBirth" format="long" />
                            <template x-if="'dateOfBirth' in $store.SERVICE_WIDOW_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_WIDOW_STORE.formValidator.dateOfBirth[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full" wire:ignore>
                            ...
                            <x-select.select2 id="gender" x-init="initSelect({ placeholder: 'pilih jenis kelamin' })"
                                x-model="$store.SERVICE_WIDOW_STORE.form.gender">
                                <option></option>
                                <option value="male">Laki-Laki</option>
                                <option value="female">Perempuan</option>
                            </x-select.select2>
                            <template x-if="'gender' in $store.SERVICE_WIDOW_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_WIDOW_STORE.formValidator.gender[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full" wire:ignore>
                            ...
                            <x-select.select2 id="citizenship" x-init="initSelect({ placeholder: 'pilih kewarganegaraan' })"
                                x-model="$store.SERVICE_WIDOW_STORE.form.citizenship">
                                <option></option>
                                <option value="indonesia">Indonesia</option>
                                <option value="foreign">Warga Negara Asing</option>
                            </x-select.select2>
                            <template x-if="'citizenship' in $store.SERVICE_WIDOW_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_WIDOW_STORE.formValidator.citizenship[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full" wire:ignore>
                            ...
                            <x-select.select2 id="religion" x-init="initSelect({ placeholder: 'pilih agama' })"
                                x-model="$store.SERVICE_WIDOW_STORE.form.religion">
                                <option></option>
                            ...
                            <template x-if="'religion' in $store.SERVICE_WIDOW_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_WIDOW_STORE.formValidator.religion[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full" wire:ignore>
                            ...
                            <x-select.select2 id="marriage" x-init="initSelect({ placeholder: 'pilih status perkawinan' })"
                                x-model="$store.SERVICE_WIDOW_STORE.form.marriage">
                                <option></option>
                                <option value="divorced" class="py-1.5">Cerai Hidup</option>
                                <option value="widowed" class="py-1.5">Cerai Mati</option>
                            </x-select.select2>
                            <template x-if="'marriage' in $store.SERVICE_WIDOW_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_WIDOW_STORE.formValidator.marriage[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full col-span-2">
                            ...
                            <x-input.text.text id="job" x-model="$store.SERVICE_WIDOW_STORE.form.job" />
                        </div>
                        <div class="w-full col-span-2">
                            ...
                            <x-input.text.textarea id="address" rows="3"
                                x-model="$store.SERVICE_WIDOW_STORE.form.address" />
                            <template x-if="'address' in $store.SERVICE_WIDOW_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_WIDOW_STORE.formValidator.address[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full col-span-2">
                            ...
                            <x-input.text.text id="spouse-name"
                                x-model="$store.SERVICE_WIDOW_STORE.form.spouseName" />
                            <template x-if="'spouseName' in $store.SERVICE_WIDOW_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_WIDOW_STORE.formValidator.spouseName[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                    </div>
                    ...
                    <div class="w-full grid grid-cols-2 gap-x-7 gap-y-7 mb-10">
                        ...
                        <div class="w-full col-span-2 flex justify-center items-center" wire:ignore>
                            <x-captcha.recaptcha store="SERVICE_WIDOW_STORE" stateData="captchaToken" />
                        </div>
                    </div>

                    <button class="w-full rounded-lg text-md text-white py-2.5 bg-brand-500"
                        x-on:click="$store.SERVICE_WIDOW_STORE.send()">
                        <span>Kirim</span>
                    </button>
                </div>
            </div>
    ...
    <div>
        <div x-cloak x-show="$store.SERVICE_WIDOW_STORE.showReceipt"
        ...
        <div x-cloak x-show="$store.SERVICE_WIDOW_STORE.showReceipt"
            ...
            <div class="bg-white rounded-lg shadow-lg w-[40rem] p-4">
                <p class="text-lg text-accent-500 text-center font-bold mb-5">SURAT KETERANGAN JANDA BERHASIL
                    DIBUAT
                </p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-sm text-neutral-700"
                                        x-text="$store.SERVICE_WIDOW_STORE.receiptData.referenceNumber"></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span class="text-sm text-neutral-700"
                                        x-text="$store.SERVICE_WIDOW_STORE.receiptData.applicantName"></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span class="text-sm text-neutral-700"
                                        x-text="$store.SERVICE_WIDOW_STORE.receiptData.applicantPhone"></span>
                                </td>
                            </tr>
                        </table>
                        <div class="w-full flex items-center gap-1">
                            <button x-on:click="$store.SERVICE_WIDOW_STORE.closeReceipt()"
                            ...
                            <button
                                ...
                                x-on:click="$store.SERVICE_WIDOW_STORE.download()">
    ...
    <x-alert.confirmation onAccept="$store.SERVICE_WIDOW_STORE.onAccept()">
        <p class="text-sm text-neutral-700 text-justify">Anda akan mengirim permohonan <span
                class="font-semibold">Surat Keterangan Janda</span>. Pastikan data yang anda isi sudah
            lengkap dan
                ...
                init: function() {
                    Livewire.hook('component.init', ({
                        ...
                        const componentID = document.querySelector(
                            '[data-component-id="online-letter-widow"]')?.getAttribute(
                            'wire:id');
