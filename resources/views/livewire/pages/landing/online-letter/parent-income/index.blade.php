<section id="online-letter-parent-income" data-component-id="online-letter-parent-income" class="w-full">
    ...
    <div class="w-full py-10">
        <x-container.landing-container class="">
            <p class="text-center text-accent-500 text-lg font-bold mb-10">
                FORMULIR SURAT KETERANGAN PENGHASILAN ORANG TUA PENDUDUK DESA BERAN
            </p>
                ...
                <div class="w-full">
                    ...
                    <div class="w-full grid grid-cols-2 gap-x-7 gap-y-7">
                        <div class="w-full">
                            ...
                            <x-input.text.text id="name" x-model="$store.SERVICE_PARENT_INCOME_STORE.form.name" />
                            <template x-if="'name' in $store.SERVICE_PARENT_INCOME_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_PARENT_INCOME_STORE.formValidator.name[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full">
                            ...
                            <x-input.text.text id="nik" x-model="$store.SERVICE_PARENT_INCOME_STORE.form.nik" />
                            <template x-if="'nik' in $store.SERVICE_PARENT_INCOME_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_PARENT_INCOME_STORE.formValidator.nik[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full">
                        ...
                        <div class="w-full">
                            ...
                            <x-input.date.datepicker id="date-of-birth" store="SERVICE_PARENT_INCOME_STORE"
                        ...
                        <div class="w-full" wire:ignore>
                            ...
                            <x-select.select2 id="gender" x-init="initSelect({ placeholder: 'pilih jenis kelamin' })"
                                x-model="$store.SERVICE_PARENT_INCOME_STORE.form.gender">
                                <option></option>
                                <option value="male">Laki-Laki</option>
                                <option value="female">Perempuan</option>
                            </x-select.select2>
                            <template x-if="'gender' in $store.SERVICE_PARENT_INCOME_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_PARENT_INCOME_STORE.formValidator.gender[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full" wire:ignore>
                            ...
                            <x-select.select2 id="citizenship" x-init="initSelect({ placeholder: 'pilih kewarganegaraan' })"
                                x-model="$store.SERVICE_PARENT_INCOME_STORE.form.citizenship">
                                <option></option>
                        ...
                        <div class="w-full" wire:ignore>
                            ...
                            <x-select.select2 id="religion" x-init="initSelect({ placeholder: 'pilih agama' })"
                                x-model="$store.SERVICE_PARENT_INCOME_STORE.form.religion">
                                <option></option>
                            ...
                            <template x-if="'religion' in $store.SERVICE_PARENT_INCOME_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_PARENT_INCOME_STORE.formValidator.religion[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full" wire:ignore>
                            ...
                            <x-select.select2 id="marriage" x-init="initSelect({ placeholder: 'pilih status perkawinan' })"
                                x-model="$store.SERVICE_PARENT_INCOME_STORE.form.marriage">
                                <option></option>
                                <option value="married" class="py-1.5">Kawin</option>
                                <option value="not-married" class="py-1.5">Belum Kawin</option>
                            </x-select.select2>
                            <template x-if="'marriage' in $store.SERVICE_PARENT_INCOME_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_PARENT_INCOME_STORE.formValidator.marriage[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full col-span-2">
                            ...
                            <x-input.text.text id="job" x-model="$store.SERVICE_PARENT_INCOME_STORE.form.job" />
                        </div>
                        <div class="w-full col-span-2">
                            ...
                            <x-input.text.textarea id="address" rows="3"
                                x-model="$store.SERVICE_PARENT_INCOME_STORE.form.address" />
                            <template x-if="'address' in $store.SERVICE_PARENT_INCOME_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_PARENT_INCOME_STORE.formValidator.address[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                    </div>
                    <p class="text-md font-bold text-neutral-700 my-5">B. Data Wali / Orang Tua</p>
                    <div class="w-full grid grid-cols-2 gap-x-7 gap-y-7">
                        <div class="w-full">
                            <x-label.label for="parent-name">
                                <span>Nama Lengkap</span>
                                <span class="text-red-500 text-sm italic">*</span>
                            </x-label.label>
                        ...
                        <div class="w-full">
                            <x-label.label for="parent-birth-place">
                                <span>Tempat Lahir</span>
                                <span class="text-red-500 text-sm italic">* <span class="text-xs">(Nama kota /
                                        kabupaten)</span></span>
                            </x-label.label>
                            <x-input.text.text id="parent-birth-place"
                        ...
                        <div class="w-full">
                            <x-label.label for="parent-date-of-birth">
                                <span>Tanggal Lahir</span>
                                <span class="text-red-500 text-sm italic">*</span>
                            </x-label.label>
                            <x-input.date.datepicker id="parent-date-of-birth" store="SERVICE_PARENT_INCOME_STORE"
                        ...
                        <div class="w-full" wire:ignore>
                            <label for="parent-gender" class="text-sm text-neutral-700 block mb-1">
                                <span>Jenis Kelamin</span>
                                <span class="text-red-500 text-sm italic">*</span>
                            </label>
                            <x-select.select2 id="parent-gender" x-init="initSelect({ placeholder: 'pilih jenis kelamin' })"
                                x-model="$store.SERVICE_PARENT_INCOME_STORE.form.parentGender">
                                <option></option>
                                <option value="male">Laki-Laki</option>
                                <option value="female">Perempuan</option>
                            </x-select.select2>
                        ...
                        <div class="w-full" wire:ignore>
                            <label for="parent-citizenship" class="text-sm text-neutral-700 block mb-1">
                                <span>Kewarganegaraan</span>
                                <span class="text-red-500 text-sm italic">*</span>
                            </label>
                            <x-select.select2 id="parent-citizenship" x-init="initSelect({ placeholder: 'pilih kewarganegaraan' })"
                                x-model="$store.SERVICE_PARENT_INCOME_STORE.form.parentCitizenship">
                                <option></option>
                                <option value="indonesia">Indonesia</option>
                                <option value="foreign">Warga Negara Asing</option>
                            </x-select.select2>
                        ...
                        <div class="w-full" wire:ignore>
                            <label for="parent-religion" class="text-sm text-neutral-700 block mb-1">
                                <span>Agama</span>
                                <span class="text-red-500 text-sm italic">*</span>
                            </label>
                            <x-select.select2 id="parent-religion" x-init="initSelect({ placeholder: 'pilih agama' })"
                                x-model="$store.SERVICE_PARENT_INCOME_STORE.form.parentReligion">
                                <option></option>
                                <option value="islam">Islam</option>
                                <option value="kristen">Kristen</option>
                                <option value="katholik">Katholik</option>
                        ...
                        <div class="w-full" wire:ignore>
                            <label for="parent-marriage" class="text-sm text-neutral-700 block mb-1">
                                <span>Status Perkawinan</span>
                                <span class="text-red-500 text-sm italic">*</span>
                            </label>
                            <x-select.select2 id="parent-marriage" x-init="initSelect({ placeholder: 'pilih status perkawinan' })"
                                x-model="$store.SERVICE_PARENT_INCOME_STORE.form.parentMarriage">
                                <option></option>
                                <option value="married" class="py-1.5">Kawin</option>
                                <option value="not-married" class="py-1.5">Belum Kawin</option>
                            </x-select.select2>
                        ...
                        <div class="w-full col-span-2">
                            ...
                            <x-input.text.textarea id="parent-address" rows="3"
                        ...
                        <div class="w-full">
                            <x-label.label for="father-income-per-month">
                        ...
                        <div class="w-full">
                            <x-label.label for="mother-income-per-month">
                                <span>Penghasilan Ibu Per Bulan</span>
                                <span class="text-red-500 text-sm italic">*</span>
                            </x-label.label>
                    ...
                    <div class="w-full grid grid-cols-2 gap-x-7 gap-y-7 mb-10">
                        <div class="w-full">
                            ...
                            <x-input.text.text id="applicant_name"
                                x-model="$store.SERVICE_PARENT_INCOME_STORE.form.applicantName" />
                            <template x-if="'applicantName' in $store.SERVICE_PARENT_INCOME_STORE.formValidator">
                                <x-label.validator>
                                    <span
                                        x-text="$store.SERVICE_PARENT_INCOME_STORE.formValidator.applicantName[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full">
                            ...
                            <x-input.text.text id="applicant_name"
                                x-model="$store.SERVICE_PARENT_INCOME_STORE.form.applicantPhone" />
                            <template x-if="'applicantPhone' in $store.SERVICE_PARENT_INCOME_STORE.formValidator">
                                <x-label.validator>
                                    <span
                                        x-text="$store.SERVICE_PARENT_INCOME_STORE.formValidator.applicantPhone[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full col-span-2 flex justify-center items-center" wire:ignore>
                            <x-captcha.recaptcha store="SERVICE_PARENT_INCOME_STORE" stateData="captchaToken" />
                        </div>
                    </div>

                    <button class="w-full rounded-lg text-md text-white py-2.5 bg-brand-500"
                        x-on:click="$store.SERVICE_PARENT_INCOME_STORE.send()">
                        <span>Kirim</span>
                    </button>
                </div>
            </div>
    ...
    <div>
        <div x-cloak x-show="$store.SERVICE_PARENT_INCOME_STORE.showReceipt"
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-sm text-neutral-700"
                                        x-text="$store.SERVICE_PARENT_INCOME_STORE.receiptData.referenceNumber"></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span class="text-sm text-neutral-700"
                                        x-text="$store.SERVICE_PARENT_INCOME_STORE.receiptData.applicantName"></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span class="text-sm text-neutral-700"
                                        x-text="$store.SERVICE_PARENT_INCOME_STORE.receiptData.applicantPhone"></span>
                                </td>
                            </tr>
                        </table>
                        <div class="w-full flex items-center gap-1">
                            <button x-on:click="$store.SERVICE_PARENT_INCOME_STORE.closeReceipt()"
                            ...
                            <button
                                ...
                                x-on:click="$store.SERVICE_PARENT_INCOME_STORE.download()">
        ...
        document.addEventListener('alpine:init', () => {
            ...
            const STORE_PROPS = {
                ...
                form: {
                    ...
                    parentJob: '',
                    parentAddress: '',
                    fatherIncomePerMonth: '',
                    motherIncomePerMonth: '',
                    applicantName: '',
                    applicantPhone: '',
                },
                showReceipt: false,
                ...
                init: function() {
                    Livewire.hook('component.init', ({
                        ...
                        const componentID = document.querySelector(
                            '[data-component-id="online-letter-parent-income"]')?.getAttribute(
                            'wire:id');
                        ...
                        .then(response => {
                            ...
                            switch (status) {
                                case 201:
                                    this.formClear();
                                    const code = data['url'];
                                    const parentIncome = data['parent_income'];
                                    const {
                                        name, phone
                                    } = data['applicant']
                                    const referenceNumber = parentIncome['reference_number'];
