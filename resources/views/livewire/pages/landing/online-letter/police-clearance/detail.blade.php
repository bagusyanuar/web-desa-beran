    ...
    <div class="w-full py-10">
        <x-container.landing-container class="">
            <p class="text-center text-accent-500 text-lg font-bold mb-10">
                INFORMASI PENGAJUAN SURAT PENGANTAR KETERANGAN CATATAN KEPOLISIAN
            </p>
            <div class="w-5/6 justify-self-center bg-white rounded-xl shadow-xl p-6 border border-neutral-300">
                <div class="w-full">
                    ...
                    <p class="text-sm font-bold text-neutral-700 mb-3 mt-5">C. Data Permohonan</p>
                    ...
                    <p class="text-sm font-bold text-neutral-700 mb-3 mt-5">D. Persayaratan</p>
                    <div
