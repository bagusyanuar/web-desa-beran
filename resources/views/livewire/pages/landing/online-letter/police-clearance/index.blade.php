<section id="online-letter-police-clearance" data-component-id="online-letter-police-clearance" class="w-full">
    <div class="w-full h-[20rem] relative">
        ...
        <div class="w-full h-full absolute top-0 left-0 bg-white/80 flex items-center justify-center">
            <x-container.landing-container class="flex flex-col items-center gap-3">
                <h1 class="text-4xl text-accent-700 font-bold">SURAT PENGANTAR KETERANGAN CATATAN KEPOLISIAN</h1>
                <p class="text-md text-brand-500 w-1/2 text-center">Layanan ini membantu Anda mendapatkan surat
                    pengantar resmi dari kelurahan/desa untuk keperluan pengurusan SKCK atau dokumen keterangan di
                    kepolisian.</p>
    ...
    <div class="w-full py-10">
        <x-container.landing-container class="">
            <p class="text-center text-accent-500 text-lg font-bold mb-10">
                FORMULIR SURAT PENGANTAR KETERANGAN CATATAN KEPOLISIAN PENDUDUK DESA BERAN
            </p>
                ...
                <div class="w-full">
                    <div
                        ...
                        <div class="flex-1">
                            ...
                            <ol class="list-decimal list-outside ml-4 text-sm">
                                ...
                                <li>
                                    <p>Fotokopi BPJS Kesehatan</p>
                                </li>
                                <li>
                                    <p>Surat Pengantar dari Desa</p>
                                </li>
                            </ol>
                    ...
                    <div class="w-full grid grid-cols-2 gap-x-7 gap-y-7">
                        <div class="w-full">
                            ...
                            <x-input.text.text id="name"
                                x-model="$store.SERVICE_POLICE_CLEARANCE_STORE.form.name" />
                            <template x-if="'name' in $store.SERVICE_POLICE_CLEARANCE_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.formValidator.name[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full">
                            ...
                            <x-input.text.text id="nik"
                                x-model="$store.SERVICE_POLICE_CLEARANCE_STORE.form.nik" />
                            <template x-if="'nik' in $store.SERVICE_POLICE_CLEARANCE_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.formValidator.nik[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full">
                            ...
                            <x-input.text.text id="birth-place"
                                x-model="$store.SERVICE_POLICE_CLEARANCE_STORE.form.birthPlace" />
                            <template x-if="'birthPlace' in $store.SERVICE_POLICE_CLEARANCE_STORE.formValidator">
                                <x-label.validator>
                                    <span
                                        x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.formValidator.birthPlace[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full">
                            ...
                            <template x-if="'dateOfBirth' in $store.SERVICE_POLICE_CLEARANCE_STORE.formValidator">
                                <x-label.validator>
                                    <span
                                        x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.formValidator.dateOfBirth[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full" wire:ignore>
                            ...
                            <x-select.select2 id="gender" x-init="initSelect({ placeholder: 'pilih jenis kelamin' })"
                                x-model="$store.SERVICE_POLICE_CLEARANCE_STORE.form.gender">
                                <option></option>
                                <option value="male">Laki-Laki</option>
                                <option value="female">Perempuan</option>
                            </x-select.select2>
                            <template x-if="'gender' in $store.SERVICE_POLICE_CLEARANCE_STORE.formValidator">
                                <x-label.validator>
                                    <span x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.formValidator.gender[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full" wire:ignore>
                            ...
                            <x-select.select2 id="citizenship" x-init="initSelect({ placeholder: 'pilih kewarganegaraan' })"
                                x-model="$store.SERVICE_POLICE_CLEARANCE_STORE.form.citizenship">
                                <option></option>
                                <option value="indonesia">Indonesia</option>
                                <option value="foreign">Warga Negara Asing</option>
                            </x-select.select2>
                            <template x-if="'citizenship' in $store.SERVICE_POLICE_CLEARANCE_STORE.formValidator">
                                <x-label.validator>
                                    <span
                                        x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.formValidator.citizenship[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full" wire:ignore>
                            ...
                            <x-select.select2 id="religion" x-init="initSelect({ placeholder: 'pilih agama' })"
                                x-model="$store.SERVICE_POLICE_CLEARANCE_STORE.form.religion">
                                <option></option>
                            ...
                            <template x-if="'religion' in $store.SERVICE_POLICE_CLEARANCE_STORE.formValidator">
                                <x-label.validator>
                                    <span
                                        x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.formValidator.religion[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full" wire:ignore>
                            ...
                            <x-select.select2 id="marriage" x-init="initSelect({ placeholder: 'pilih status perkawinan' })"
                                x-model="$store.SERVICE_POLICE_CLEARANCE_STORE.form.marriage">
                                <option></option>
                                <option value="married" class="py-1.5">Menikah</option>
                                <option value="not-married" class="py-1.5">Belum Menikah</option>
                            </x-select.select2>
                            <template x-if="'marriage' in $store.SERVICE_POLICE_CLEARANCE_STORE.formValidator">
                                <x-label.validator>
                                    <span
                                        x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.formValidator.marriage[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full col-span-2">
                            ...
                            <x-input.text.text id="job"
                                x-model="$store.SERVICE_POLICE_CLEARANCE_STORE.form.job" />
                        </div>
                        <div class="w-full col-span-2">
                            ...
                            <x-input.text.textarea id="address" rows="3"
                                x-model="$store.SERVICE_POLICE_CLEARANCE_STORE.form.address" />
                            <template x-if="'address' in $store.SERVICE_POLICE_CLEARANCE_STORE.formValidator">
                                <x-label.validator>
                                    <span
                                        x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.formValidator.address[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full col-span-2">
                            ...
                            <template x-if="'purpose' in $store.SERVICE_POLICE_CLEARANCE_STORE.formValidator">
                                <x-label.validator>
                                    <span
                                        x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.formValidator.purpose[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                    </div>
                    ...
                    <div class="w-full flex flex-col gap-x-7 gap-y-7">
                        <template
                            x-for="(description, index) in $store.SERVICE_POLICE_CLEARANCE_STORE.form.descriptions"
                            :key="index">
                            <div class="w-full">
                                <x-input.text.text
                        ...
                        <button
                            class="w-full rounded-lg text-md text-white py-2.5 bg-accent-500 hover:bg-accent-700 transition-all duration-200 ease-in"
                            x-on:click="$store.SERVICE_POLICE_CLEARANCE_STORE.addDescription()">
                    ...
                    <div class="w-full grid grid-cols-2 gap-x-7 gap-y-7 mb-10">
                        <div class="w-full">
                            ...
                            <x-input.text.text id="applicant_name"
                                x-model="$store.SERVICE_POLICE_CLEARANCE_STORE.form.applicantName" />
                            <template x-if="'applicantName' in $store.SERVICE_POLICE_CLEARANCE_STORE.formValidator">
                                <x-label.validator>
                                    <span
                                        x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.formValidator.applicantName[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full">
                            ...
                            <x-input.text.text id="applicant_name"
                                x-model="$store.SERVICE_POLICE_CLEARANCE_STORE.form.applicantPhone" />
                            <template x-if="'applicantPhone' in $store.SERVICE_POLICE_CLEARANCE_STORE.formValidator">
                                <x-label.validator>
                                    <span
                                        x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.formValidator.applicantPhone[0]"></span>
                                </x-label.validator>
                            </template>
                        </div>
                        <div class="w-full col-span-2 flex justify-center items-center" wire:ignore>
                            <x-captcha.recaptcha store="SERVICE_POLICE_CLEARANCE_STORE" stateData="captchaToken" />
                        </div>
                    </div>

                    <button class="w-full rounded-lg text-md text-white py-2.5 bg-brand-500"
                        x-on:click="$store.SERVICE_POLICE_CLEARANCE_STORE.send()">
                        <span>Kirim</span>
                    </button>
                </div>
            </div>
    ...
    <div>
        <div x-cloak x-show="$store.SERVICE_POLICE_CLEARANCE_STORE.showReceipt"
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="text-sm text-neutral-700"
                                        x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.receiptData.referenceNumber"></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span class="text-sm text-neutral-700"
                                        x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.receiptData.applicantName"></span>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <span class="text-sm text-neutral-700"
                                        x-text="$store.SERVICE_POLICE_CLEARANCE_STORE.receiptData.applicantPhone"></span>
                                </td>
                            </tr>
                        </table>
                        <div class="w-full flex items-center gap-1">
                            <button x-on:click="$store.SERVICE_POLICE_CLEARANCE_STORE.closeReceipt()"
                            ...
                            <button
                                ...
                                x-on:click="$store.SERVICE_POLICE_CLEARANCE_STORE.download()">
    ...
    <x-alert.confirmation onAccept="$store.SERVICE_POLICE_CLEARANCE_STORE.onAccept()">
        <p class="text-sm text-neutral-700 text-justify">Anda akan mengirim permohonan <span
                class="font-semibold">Surat Keterangan Pengantar Keterangan Kepolisan</span>. Pastikan data yang anda
            isi sudah
            lengkap dan
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            ...
            const STORE_PROPS = {
                        ...
                        .then(response => {
                            ...
                            switch (status) {
                                case 201:
                                    this.formClear();
                                    const code = data['url'];
                                    const policeClearance = data['police_clearance'];
                                    const {
                                        name, phone
                                    } = data['applicant']
                                    const referenceNumber = policeClearance['reference_number'];
                ...
                addDescription() {
                    const containsEmptyString = this.form.descriptions.includes('');
