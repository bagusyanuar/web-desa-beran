@section('meta-og')
    @if (!empty($data))
        ...
        <meta property="og:description" content="Perpustakaan Online Desa Beran" />
...
<section id="library-detail" data-component-id="library-detail" class="w-full">
    ...
    <div class="w-full py-10">
        <x-container.landing-container class="">
            <div class="w-full flex items-center gap-1 mb-5" wire:ignore x-data="{
                ...
                <a href="{{ route('library') }}" class="text-brand-500 font-semibold hover:underline">Perpustakaan
                    Online</a>
                @if (!empty($data))
                    <div wire:ignore class="text-brand-500">
                        <i data-lucide="chevron-right" class="h-4 aspect-[1/1]"></i>
