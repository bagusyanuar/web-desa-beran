    ...
    <div class="w-full py-10">
        <x-container.landing-container class="">
            ...
            <div class="w-full p-6 rounded-lg bg-white shadow-xl border border-neutral-300 mb-7">
                <p class="text-lg text-accent-500 font-bold mb-3 leading-[1] text-center">Penelusuran Perpustakaan Online</p>
                <div class="flex items-center border border-neutral-300 rounded-md w-full" wire:ignore>
                    ...
                    <input type="text" placeholder="telusuri perpustakaan online desa beran..."
                        x-model="$store.SERVICE_LIBRARY_STORE.param" x-on:input="$store.SERVICE_LIBRARY_STORE.onSearch()"
