<section id="online-letter-income-detail" data-component-id="online-letter-income-detail" class="w-full">
    <div class="mb-7 flex items-start gap-3">
        ...
        <div>
            <p class="text-xl text-neutral-700 font-bold">Surat Keterangan Penghasilan</p>
            <p class="text-md text-neutral-500">Halaman ini digunakan untuk mengelola surat keterangan penghasilan.</p>
        </div>
    </div>
