<section id="online-letter-domicile-detail" data-component-id="online-letter-domicile-detail" class="w-full">
    <div class="mb-5 flex items-start gap-2">
        ...
        <div>
            <p class="text-lg text-neutral-700 font-semibold leading-[1.2]">Surat Keterangan Domisili</p>
            <p class="text-sm text-neutral-500">Halaman ini digunakan untuk mengelola surat keterangan domisili.</p>
        </div>
    </div>
    <div class="w-full flex items-start gap-4">
        <div class="flex-1 p-6 bg-white shadow-2xl rounded-lg border-t-4 border-accent-500">
            ...
            <div class="w-full overflow-hidden rounded-lg border border-neutral-300 shadow-md">
            ...
            @if (
                ...
                <div class="w-full flex flex-col gap-2">
                    ...
                    @if ($data->status === App\Commons\Enum\CertificateStatus::Pending->value)
                        <button x-on:click="$store.SERVICE_DOMICILE_DETAIL_STORE.finish()"
