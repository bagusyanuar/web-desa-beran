                    ...
                    <tr class="even:bg-white odd:bg-brand-50">
                        ...
                        <td class="px-3 py-2.5">
                            @php
                                \Carbon\Carbon::setLocale('id');
                            @endphp
                            <span>{{ \Carbon\Carbon::parse($data->record->date)->translatedFormat('l, d F Y') }} ({{ floor(\Carbon\Carbon::parse($data->person->date_of_birth)->diffInYears(\Carbon\Carbon::parse($data->record->date)))." Tahun" }})</span>
                        </td>
                    </tr>
                    <tr class="even:bg-white odd:bg-brand-50">
                        <td class="px-3 py-2.5">
