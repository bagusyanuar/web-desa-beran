<section id="online-letter-widow" data-component-id="online-letter-widow" class="w-full">
    <div class="mb-5">
        <p class="text-lg text-neutral-700 font-semibold leading-[1.2]">Surat Keterangan Janda</p>
        <p class="text-sm text-neutral-500">Halaman ini digunakan untuk mengelola surat keterangan janda.</p>
    </div>
    <div class="w-full bg-white shadow-2xl p-6 rounded-lg border-t-4 border-accent-500">
        <div class="flex items-center justify-between mb-3">
            ...
            <div class="flex items-center gap-1">
                <x-table.search store="SERVICE_WIDOW_STORE" dispatcher="findAll" />
                <x-table.filter>
                    <div class="w-64 flex flex-col">
                        ...
                        <div class="w-full flex flex-col gap-2 mb-5">
                            <div class="w-full flex items-center">
                                <input type="checkbox" id="created" value="created"
                                    x-model="$store.SERVICE_WIDOW_STORE.status"
                        ...
                        <div class="flex items-center mb-3 gap-1">
                            <div class="flex-1" wire:ignore>
                                <x-input.date.datepicker class="!text-xs" id="start-date" store="SERVICE_WIDOW_STORE"
                        ...
                        <div class="w-full">
                            <button x-on:click="open = false; $store.SERVICE_WIDOW_STORE.filter()"
        ...
        <x-table.table store="SERVICE_WIDOW_STORE">
            <x-table.thead>
                    ...
                    <x-table.row>
                        ...
                        <x-table.td width="w-[80px]" align="center">
                            <div wire:ignore x-data="{
                                ...
                                x-on:click="$store.SERVICE_WIDOW_STORE.redirectToDetail(v.id)">
        ...
        <x-table.pagination store="SERVICE_WIDOW_STORE" dispatcher="findAll" />
    </div>
</section>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            ...
            const STORE_PROPS = {
                ...
                redirectToDetail(id) {
                    window.location.href = '/web-panel/surat-keterangan-janda/' + id;
                },
                filter() {
                    this.findAll()
                }
