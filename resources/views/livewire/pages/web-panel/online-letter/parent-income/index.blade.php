<section id="online-letter-parent-income" data-component-id="online-letter-parent-income" class="w-full">
    <div class="mb-7">
        <p class="text-xl text-neutral-700 font-bold">Surat Keterangan Penghasilan Orang Tua</p>
        <p class="text-md text-neutral-500">Halaman ini digunakan untuk mengelola surat keterangan penghasilan orang tua.
        </p>
    </div>
    <div class="w-full p-3 bg-white border border-neutral-300 shadow-xl rounded-lg">
        <div class="flex items-center justify-between mb-3">
            <x-table.search store="SERVICE_PARENT_INCOME_STORE" dispatcher="findAll" />
            <x-table.filter>
                    ...
                    <div class="w-full flex flex-col gap-2 mb-5">
                        <div class="w-full flex items-center">
                            <input type="checkbox" id="created" value="created"
                                x-model="$store.SERVICE_PARENT_INCOME_STORE.status"
                    ...
                    <div class="flex items-center mb-3 gap-1">
                        <div class="flex-1" wire:ignore>
                            <x-input.date.datepicker class="!text-xs" id="start-date"
                                store="SERVICE_PARENT_INCOME_STORE" stateDate="startDate" format="slash" />
                        </div>
                        <span class="text-xs text-neutral-700">/</span>
                        <div class="flex-1" wire:ignore>
                            <x-input.date.datepicker class="!text-xs" id="start-date"
                                store="SERVICE_PARENT_INCOME_STORE" stateDate="endDate" format="slash" />
                        </div>
                    </div>
                    <div class="w-full">
                        <button x-on:click="open = false; $store.SERVICE_PARENT_INCOME_STORE.filter()"
        ...
        <x-table.table store="SERVICE_PARENT_INCOME_STORE">
            <x-table.thead>
                    ...
                    <x-table.row>
                        ...
                        <x-table.td width="w-[80px]" align="center">
                            <div wire:ignore x-data="{
                                ...
                                x-on:click="$store.SERVICE_PARENT_INCOME_STORE.redirectToDetail(v.id)">
        ...
        <x-table.pagination store="SERVICE_PARENT_INCOME_STORE" dispatcher="findAll" />
    </div>
</section>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            ...
            const STORE_PROPS = {
                ...
                redirectToDetail(id) {
                    window.location.href = '/web-panel/surat-keterangan-penghasilan-orang-tua/' + id;
                },
                filter() {
                    this.findAll()
                }
