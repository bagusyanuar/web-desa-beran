<section id="community" data-component-id="community" class="w-full">
    <div class="mb-7">
        <p class="text-xl text-neutral-700 font-bold">Masyarakat Desa</p>
        <p class="text-md text-neutral-500">Halaman ini digunakan untuk mengelola profil masyarakat desa beran.
        </p>
    </div>
