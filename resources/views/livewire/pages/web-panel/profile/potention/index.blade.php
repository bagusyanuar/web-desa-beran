<section id="potention" data-component-id="potention" class="w-full">
    <div class="mb-7">
        <p class="text-xl text-neutral-700 font-bold">Potensi Desa</p>
        <p class="text-md text-neutral-500">Halaman ini digunakan untuk mengelola profil potensi desa beran.
        </p>
    </div>
