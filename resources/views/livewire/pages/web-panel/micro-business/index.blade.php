<section id="micro-business" data-component-id="micro-business" class="w-full">
                ...
                <template x-for="(v, index) in data" :key="index">
                    <x-table.row>
                        ...
                        <x-table.td width="w-[220px]" align="center">
                            <span class="text-sm text-neutral-700 text-center" x-text="v.owner?.name || '-'"></span>
                        </x-table.td>
                            ...
                            <x-popper.popper>
                                ...
                                <div x-bind="popperContentBind"
                                    ...
                                    <div class="flex flex-col py-1 justify-start items-start">
                                        <div x-on:click="$store.SERVICE_MICRO_BUSINESS_STORE.goToDetail(v.id)"
                                        ...
                                        <div x-on:click="$store.SERVICE_MICRO_BUSINESS_STORE.confirm(v.id)"
                                            class="flex items-center justify-start gap-1 w-full text-xs px-2 py-1.5 cursor-pointer hover:bg-neutral-50">
                                            <div wire:ignore>
    ...
    <x-alert.confirmation title="Konfirmasi Produk UMKM" onAccept="$store.SERVICE_MICRO_BUSINESS_STORE.onConfirm()"
        ...
        <p class="text-sm text-neutral-700 text-justify">Anda akan mengkonfirmasi <span
                ...
                Produk UMKM Baru</span>. Pastikan data yang anda pilih sudah
