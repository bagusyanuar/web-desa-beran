<section id="setting-gretting-word" data-component-id="setting-gretting-word" class="w-full">
    <div class="mb-5">
    ...
    <x-alert.confirmation title="Konfirmasi Perubahan Profil"
        onAccept="$store.SERVICE_SETTING_GREETING_WORD_STORE.onConfirm()" acceptText="Konfrimasi">
...
@push('scripts')
    <script>
        document.addEventListener('alpine:init', () => {
            const STORE_NAME = 'SERVICE_SETTING_GREETING_WORD_STORE';
            const STORE_PROPS = {
                component: null,
                alertStore: null,
                ...
                init: function() {
                    Livewire.hook('component.init', ({
                        ...
                        const componentID = document.querySelector(
                            '[data-component-id="setting-gretting-word"]')?.getAttribute(
                            'wire:id');
                ...
                async onConfirm() {
                    ...
                    switch (status) {
                        case 200:
                            this.toastStore.success("Berhasil mengganti teks ucapan", 2000,
                                function() {
