<div>
    <div class="fixed inset-0 bg-black/30 z-[100]" x-cloak x-show="$store.pageLoaderStore.showLoader">
    </div>
    <div x-cloak x-show="$store.pageLoaderStore.showLoader"
        ...
        class="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[101] flex items-center justify-center">
